                ...
                <div className="flex flex-col gap-4">
                    {tickets && tickets.length === 0 &&
                        <div className="flex flex-col items-center">
                            ...
                            <Typography variant="lead" className="text-center lg:w-3/4">
                                It looks like you don&apos;t have any tickets yet. If you have recently purchased a ticket either through SchoolCashOnline, or in-person, 
                                please keep in mind that it may take some time for it to show up here. In this case, please be patient as we work to get your ticket added.
                            </Typography>
                        </div>
                    }
