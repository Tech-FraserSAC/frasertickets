                ...
                <tbody className="border-collapse border-2 border-gray-500">
                                ...
                                <div className="flex flex-row gap-1 items-center justify-end w-full">
                                    ...
                                    <span>
                                        {cleanDisplayNameWithStudentNumber(
                                            ticketSearchMutation.data?.ownerData.full_name,
                                            ticketSearchMutation.data?.ownerData.student_number,
                                        )}
                                    </span>
                                </div>
                    ...
                    <tr className="border-collapse border-2 border-gray-500">
                        ...
                        <td className="border-collapse border-2 border-gray-500 text-right px-2 text-blue-500 hover:text-blue-700 hover:underline">
                            <Link
                                href={`/events/${ticketSearchMutation.data?.eventId}`}
                                target="_blank"
                                rel="noreferrer"
                            >
                    ...
                    <tr className="border-collapse border-2 border-gray-500">
                        ...
                        <td className="border-collapse border-2 border-gray-500 text-right px-2">
                            {ticketSearchMutation.data?.scanCount.toString()}
                        </td>
                    </tr>
                    ...
                    <tr className="border-collapse border-2 border-gray-500">
                        ...
                        <td className="border-collapse border-2 border-gray-500 text-right px-2">
                            {ticketSearchMutation.data?.maxScanCount === 0 ? (
                                <>&infin;</>
                            ) : (
                                ticketSearchMutation.data?.maxScanCount.toString()
                            )}
                        </td>
                    </tr>
                    ...
                    <tr className="border-collapse border-2 border-gray-500">
                        ...
                        <td className="border-collapse border-2 border-gray-500 text-right px-2">
                            {ticketSearchMutation.data?.scanCount === 0
                                ? "N/A"
                                : ticketSearchMutation.data?.lastScanTime.toLocaleString("en-US", {
                                      day: "2-digit",
                                      month: "2-digit",
                                      year: "2-digit",
                                      hour: "2-digit",
