...
export default function EventSpecificPage() {
    ...
    const {
        ...
        error,
        data,
    } = useQuery("frasertix-event", () => getEvent(id as string), {
            ...
            {isLoading || error ? (
                ...
                <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-8 xl:gap-12">
                    <div className="flex flex-col items-center lg:items-start lg:w-1/2 mb-6">
                        <Link
                            href="/events"
                            className="flex items-center gap-1 self-start text-blue-500 hover:text-blue-600 text-lg font-medium mb-2"
                        >
                            <AiOutlineArrowLeft />
                            <span>Events</span>
                        </Link>
                        ...
                        <Carousel
                            className="md:w-1/2 lg:w-full rounded-xl"
                            autoplay={true}
                        >
