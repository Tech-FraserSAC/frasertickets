    ...
    return (
        ...
        >
            <div className="flex flex-col p-8">
                <h1 className="text-8xl text-center mb-2 font-semibold text-red-500">500</h1>
                <h2 className="text-3xl text-center mb-6 text-black">Server Error</h2>

                <p className="text-xl text-center mb-6 text-gray-700">
                    Sorry, something went wrong on our side while processing your request. We&apos;ll get this fixed as
                    soon as possible.
                </p>
